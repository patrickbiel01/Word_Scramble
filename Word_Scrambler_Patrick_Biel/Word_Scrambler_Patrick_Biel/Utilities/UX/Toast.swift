/*
 Base Class used for imitating toasts in Android
...
class Toast
{
    func showAlert(backgroundColor:UIColor, textColor:UIColor, message:String)
    {
        ...
        label.frame = CGRect(x: appDelegate.window!.frame.size.width, y: 200, width: appDelegate.window!.frame.size.width, height: 45)
